...
public class Password_Database extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE "  + TABLE_NAME + "( password TEXT,path TEXT )  ");
    }
    ...
    public boolean insertData(String pass, String dir) {

        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(col1,pass);
        contentValues.put(col2,dir);
...
//            return true;
    ...
    public boolean updateData(String dir, String pass){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
